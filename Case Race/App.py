...
class TeamBadge(ttk.Frame):
    def __init__(self, master, team_name, button_names, team_color):
        ...
        # Team Name Label
        self.team_name_label = ttk.Label(
            self,
            text=f"{self.team_name}: {sum(self.counters.values())}",
            font=('Helvetica', 12, 'bold'),
            foreground=self.team_color
        )
        ...
        self.buttons = {
            button_name: ttk.Button(
                self,
                text=f"{button_name}",
                command=lambda btn=button_name: self.button_action(btn)
            )
...
class SimpleApp:
    def __init__(self, root):
        ...
        # Team Badges
        self.team_badge_frame = ttk.Frame(self.root, style='Translucent.TFrame')
        ...
        self.start_button = ttk.Button(
            ...
            style='Translucent.TButton'
        )
        self.start_button.pack(pady=10)

        # Add Team Button
        add_team_button = ttk.Button(
            self.root,
            text="Add Team",
    ...
    def add_team(self):
        ...
        if team_name:
            ...
            row_index = len(self.team_badge_frame.winfo_children()) // 8
